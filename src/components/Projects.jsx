      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        {/* Project 1 - estore */}
          <div className="bg-gray-800 p-6 rounded-xl shadow-lg mb-8">
           ...
           {/* Project  - Burger */}
          <div className="bg-gray-800 p-6 rounded-xl shadow-lg mb-8">
            <img src={Burger} alt="Burger App" className="rounded-lg mb-4" />
            <h3 className="text-xl font-semibold mb-2 text-amber-50">Burger Builder</h3>
            <p className="text-gray-300 mb-3"> 
             A full-stack burger ordering web application that allows users to browse products, customize orders, and complete purchases through a smooth and responsive interface. The project focuses on performance, user experience, and clean design.            </p>
            <p className="text-gray-400 mb-3">
              <span className="font-semibold">Tech:</span> MongoDB, TypeScript, Next.js, Node.js
            </p>
            <div className="flex gap-4">
              <a href="https://github.com/mahmoudrabea321/Burger-" target="_blank" className="text-indigo-400 hover:underline">GitHub</a>
              <a href="https://burger-rabea.onrender.com" target="_blank" className="text-indigo-400 hover:underline">Live Demo</a>
            </div>
